...
def generate_launch_description():
    ...
    gazebo_pkg_share = launch_ros.substitutions.FindPackageShare(package='tortoisebotpromax_gazebo').find('tortoisebotpromax_gazebo')
    default_model_path = os.path.join(pkg_share, 'urdf/tortoisebotpromax_sim.xacro')
